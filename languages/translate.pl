...
sub update_po_file
{
    ...
    $msgmerge_cmd .= " $base_path/languages/$locale/$locale.po";
    $msgmerge_cmd .= " /tmp/base.pot";
    $msgmerge_cmd .= " 2>/dev/null";
    system($msgmerge_cmd);

    # Remove POT-Creation line
    system("sed -i -e'/POT-Creation/d' $base_path/languages/$locale/$locale.po");
}
...
sub update_mo_file
{
    ...
    $msgfmt_cmd .= " -o $base_path/languages/$locale/$locale.mo";
    $msgfmt_cmd .= " $base_path/languages/$locale/$locale.po";
    system($msgfmt_cmd);
